  ...
  return (
    <div className="px-6 mt-5 mx-auto w-full    flex flex-col md:flex-row gap-6 ">
      <img
        src={favouriteBooks}
        alt="favourite Book"
        className="h-[250px] w-[300px]  object-cover object-center"
      />
      <div className="flex flex-col gap-6  w-full md:w-2/3 h-full self-center">
        ...
        <span className="text-gray-600 text-wrap  text-sm font-bold">
